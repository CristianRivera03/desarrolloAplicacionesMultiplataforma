...
class Calculadora {
    ...
    actualizarPantalla() {
        ...
        if (this.operacion != null) {
            ...
            console.log (`etapa uno`)

        }else{
            
            this.valorPrevioTextElement.innerText = ""
            console.log (`etapa dos`)
...
igualButton.addEventListener('click', _button => {
    ...
    calculator.actualizarPantalla()
    operacionShow = true
    valorPrevioTextElement.innerHTML = (`${previo} ${operacion} ${actual}`)
})
...
/*Laboratorio:
1. Arreglar bug que limite los numeros en pantalla ya 
2. Funcionabilidad de boton de porcentaje ya
3. Si lo que se presiona despues de igual es un numero entonces que borre el resultado anterior e inicie una nueva operacion ya
4. Muestre la operacion completa en el display superior ya 
*/